...
Page({
  ...
  onLoad: function (options) {
    ...
    this.setData({
      ...
      artticleSign: options.artticleSign,
    })
    if (options.artticleSign === '图片') {
      this.getArticleDesc2() // 获取文章详情
    } else if (options.artticleSign === '富文本') {
  ...
  onShow() {
    if (this.data.artticleSign === '图片') {
      this.getArticleDesc2() // 获取文章详情
    } else if (this.data.artticleSign === '富文本') {
      this.getArticleDesc() // 获取文章详情
    }
    this.getCommentList() // 获取文章评论（详情页）
  },
  ...
  followPeople(e) {
    ...
    wx.request({
      ...
      success(res) {
        ...
        if (that.data.artticleSign === '图片') {
          that.getArticleDesc2() // 获取文章详情
        } else if (that.data.artticleSign === '富文本') {
          that.getArticleDesc() // 获取文章详情
        }
      }
    })
    // followPeople({
  ...
  goto() {
    ...
    handlePreview: function (e) {
      ...
      let images = this.data.list.picture;
      wx.previewImage({
